...
- ✅ **디자인 시안(현대 절충 1c) 반영 완료** — 전례색 헤더 · 범례 · 상단 색 바 · 오늘 pill(웹) / 색 점·채운 원·하단 요약 카드(모바일). 추가 시안/수정본 있으면 마저 반영.
- [ ] **앱 아이콘 이미지** → 현재 Flutter 기본 아이콘. 로고/아이콘(1024px) 주시면 교체.
- [ ] (선택) 다크 모드 전례색 톤 검토 — 시안은 라이트 기준. 다크 팔레트 미세조정 원하면 알려주세요.
